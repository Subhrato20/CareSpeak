...
# Quick Start Script for Symptom Search Tool
# This script helps you set up and test the symptom search tool

set -e

echo "🚀 Quick Start Script for Symptom Search Tool"
echo "=============================================="
...
if [ ! -f ".env" ]; then
    ...
    echo "   - ASSISTANT_ID: Your Vapi assistant ID"
...
if python test_symptom_search.py; then
    ...
    echo ""
    echo "📚 Documentation:"
    echo "   - SYMPTOM_SEARCH_README.md - Complete setup guide"
